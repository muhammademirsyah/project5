...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Welcome screen sudah dihandle inline di HTML untuk performa maksimal
  // Fungsi hideWelcome() ada di index-new.html

  // Music toggle button (untuk halaman lama yang masih punya toggle)
  ...
  window.toggleDetail = function() {
    ...
    if (detail && btn && btnText) {
      ...
      if (detail.classList.contains('show')) {
        ...
        btnText.textContent = 'Lebih Lanjut';
      }
    }
  }
